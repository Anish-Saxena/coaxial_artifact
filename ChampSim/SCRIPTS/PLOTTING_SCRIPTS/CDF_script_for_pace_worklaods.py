...
for app in app_list:
    ...
    os.mkdir(app_short)
    os.chdir(app_short)
    os.system('scp acho44@keg4.cc.gatech.edu:~/coaxial/tmp_champsim_cxl/res_for_cdf/base/'+app+' DDR.out')
    os.system('scp acho44@keg4.cc.gatech.edu:~/coaxial/tmp_champsim_cxl/res_for_cdf/4X_24ns/'+app+' CXL.out')
