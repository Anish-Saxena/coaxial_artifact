...
#define tCXL_DRAM_NANOSECONDS 25
#define CXL_RD_BW 25.7
#define CXL_WR_BW 12.7
#define CXL_RD_CH_WIDTH_BITS 8ul
#define CXL_WR_CH_WIDTH_BITS 8ul
#define DRAM_IO_FREQ 2400ul
#define CXL_MODE 0ul
#define DRAM_CHANNELS 8ul
